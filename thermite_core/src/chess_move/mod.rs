...
mod test {
    ...
    #[test_case(ChessMove::EnPassantCapture(EnPassantCapture::new_from(DoublePawnToSquare::G5, PawnCaptureDirection::West, White).unwrap()), "g5f6")]
    #[test_case(ChessMove::EnPassantCapture(EnPassantCapture::new_from(DoublePawnToSquare::A4, PawnCaptureDirection::East, Black).unwrap()), "a4b3")]
