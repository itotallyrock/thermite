...
mod test {
    ...
    #[test_case(Castle::new(White, KingSide), BoardMask::new(0x70))]
    #[test_case(Castle::new(White, QueenSide), BoardMask::new(0x6))]
    #[test_case(Castle::new(Black, QueenSide), BoardMask::new(0x0600_0000_0000_0000))]
    #[test_case(Castle::new(Black, KingSide), BoardMask::new(0x7000_0000_0000_0000))]
